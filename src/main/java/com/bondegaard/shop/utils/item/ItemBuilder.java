...
public final class ItemBuilder {
    ...
    public ItemBuilder(Material material, int amount, String name, String... lore) {this(material, amount, (short) 0, name, lore);}

    public ItemBuilder(Material material, int amount, int i, String name, String... lore) {this(material, amount, (short) i, name, lore);}
